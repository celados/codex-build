...
PATCHES = (
    ...
    Patch("codex-chatgpt recursion limit", "codex-rs/chatgpt/src/lib.rs", "patches/build-limits/chatgpt-recursion-apply.yml", "patches/build-limits/chatgpt-recursion-satisfied.yml"),
